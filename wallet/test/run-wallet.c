...
{
	return chainparams_for_network("zcore");
}
...
bool fromwire_channel_got_commitsig(const tal_t *ctx UNNEEDED, const void *p UNNEEDED, u64 *commitnum UNNEEDED, u32 *feerate UNNEEDED, struct zcore_signature *signature UNNEEDED, secp256k1_ecdsa_signature **htlc_signature UNNEEDED, struct added_htlc **added UNNEEDED, struct secret **shared_secret UNNEEDED, struct fulfilled_htlc **fulfilled UNNEEDED, struct failed_htlc ***failed UNNEEDED, struct changed_htlc **changed UNNEEDED, struct zcore_tx **tx UNNEEDED)
...
bool fromwire_channel_sending_commitsig(const tal_t *ctx UNNEEDED, const void *p UNNEEDED, u64 *commitnum UNNEEDED, u32 *feerate UNNEEDED, struct changed_htlc **changed UNNEEDED, struct zcore_signature *commit_sig UNNEEDED, secp256k1_ecdsa_signature **htlc_sigs UNNEEDED)
...
static bool zcore_tx_eq(const struct zcore_tx *tx1,
			  const struct zcore_tx *tx2)
{
	u8 *lin1, *lin2;
	bool eq;
...
static bool channelseq(struct channel *c1, struct channel *c2)
{
	...
	if(c1->last_tx) {
		CHECK(zcore_tx_eq(c1->last_tx, c2->last_tx));
	}
...
static bool test_channel_crud(struct lightningd *ld, const tal_t *ctx)
{
	...
	struct zcore_txid *hash = tal(w, struct zcore_txid);
	struct pubkey pk;
	struct node_id id;
	...
	secp256k1_ecdsa_signature *zcore_sig1 = tal(w, secp256k1_ecdsa_signature);
	secp256k1_ecdsa_signature *node_sig2, *zcore_sig2;
	bool load;
	...
	mempat(zcore_sig1, sizeof(*zcore_sig1));
	...
	c1.last_tx = zcore_tx_from_hex(w, "", strlen(""));
	c1.last_sig.s = *sig;
	c1.last_sig.sighash_type = SIGHASH_ALL;
	c1.last_tx->chainparams = chainparams_for_network("zcore");
	...
	CHECK_MSG(!wallet_err,
		  tal_fmt(w, "Insert into DB: %s", wallet_err));
	wallet_announcement_save(w, c1.dbid, node_sig1, zcore_sig1);
	CHECK_MSG(!wallet_err,
		  tal_fmt(w, "Insert ann sigs into DB: %s", wallet_err));
	CHECK_MSG(load = wallet_remote_ann_sigs_load(w, w, c1.dbid, &node_sig2, &zcore_sig2), tal_fmt(w, "Load ann sigs from DB"));
	CHECK_MSG(!wallet_err,
	...
	CHECK_MSG(!memcmp(zcore_sig1, zcore_sig2, sizeof(*node_sig1)), "Compare ann sigs loaded with saved (v5)");
