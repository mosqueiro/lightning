#ifndef LIGHTNING_ZCORE_SCRIPT_H
#define LIGHTNING_ZCORE_SCRIPT_H
#include "config.h"
#include "signature.h"
#include "tx.h"
...
u8 *zcore_wscript_to_local(const tal_t *ctx,
			     u16 to_self_delay,
...
#define ZCORE_SCRIPTPUBKEY_P2PKH_LEN (1 + 1 + 1 + 20 + 1 + 1)

/* OP_HASH160 + PUSH(20-byte-hash) + OP_EQUAL */
#define ZCORE_SCRIPTPUBKEY_P2SH_LEN (1 + 1 + 20 + 1)

/* OP_0 + PUSH(20-byte-hash) */
#define ZCORE_SCRIPTPUBKEY_P2WPKH_LEN (1 + 1 + 20)

/* OP_0 + PUSH(32-byte-hash) */
#define ZCORE_SCRIPTPUBKEY_P2WSH_LEN (1 + 1 + 32)

#endif /* LIGHTNING_ZCORE_SCRIPT_H */
